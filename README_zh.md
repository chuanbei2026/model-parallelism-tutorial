...
Karpathy 最近分享了他的 [obsidian-llm](https://gist.github.com/karpathy/442a6bf555914893e9891c11519de94f) 知识库方案——很好地展示了如何将个人笔记变成可查询的系统。这激发了一个更进一步的想法：如果知识库不仅能回答问题，还能有一个**任务头**，把论文、PDF 和博客文章提炼成一步步的交互式教程呢？
